        ...
        <Grid columns={3} padding='0 0 40px 0'>
            ...
            <CancellationItem>
              ...
              <Column alignItems='center' justifyContent='center'>
                <ImageWrapper width='80px' height='80px'>
                  <Image src="/images/cancellation-refund/time.webp" alt='Zaman' fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </ImageWrapper>
          ...
          <GridColumn>
            <CancellationItem>
              ...
              <Column alignItems='center' justifyContent='center'>
                <ImageWrapper width='80px' height='80px'>
                  <Image src="/images/cancellation-refund/orders.webp" alt='Zaman' fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </ImageWrapper>
                <Title fsize='14px' fcolor='#5f6b76'>
                  Pasaj üzerinde
                </Title>
          ...
          <GridColumn>
            <CancellationItem>
              ...
              <Column alignItems='center' justifyContent='center'>
                <ImageWrapper width='80px' height='80px'>
                  <Image src="/images/cancellation-refund/request.webp" alt='Zaman' fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </ImageWrapper>
                <Title fsize='14px' fcolor='#5f6b76'>
          ...
          <GridColumn>
            <CancellationItem>
              ...
              <Column alignItems='center' justifyContent='center'>
                <ImageWrapper width='80px' height='80px'>
                  <Image src="/images/cancellation-refund/phone-code.webp" alt='Zaman' fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </ImageWrapper>
                <Title fsize='14px' fcolor='#5f6b76'>
                  SMS ile gelecek
                </Title>
          ...
          <GridColumn>
            <CancellationItem>
              ...
              <Column alignItems='center' justifyContent='center'>
                <ImageWrapper width='80px' height='80px'>
                  <Image src="/images/cancellation-refund/box.webp" alt='Zaman' fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
                </ImageWrapper>
                <Title fsize='14px' fcolor='#5f6b76'>
